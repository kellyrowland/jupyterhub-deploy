...
## JavaScript hook for customizing and populating options form.
#c.Spawner.options_script = ''
...
cori_login_config = dict()
cori_login_config['ssh_command'] = 'gsissh'

cori_login_config['remote_host'] = 'cori19-224.nersc.gov'
cori_login_config['remote_port'] = '2222'
if 'REMOTE_HOST' in os.environ:
    host, port = os.environ['REMOTE_HOST'].split(':')
    cori_login_config['remote_host'] = host
    cori_login_config['remote_port'] = port

cori_login_config['hub_api_url'] = 'http://jupyter-dev.nersc.gov:8082/hub/api'
if 'HUB_API_URL' in os.environ:
    cori_login_config['hub_api_url'] = os.environ['HUB_API_URL']

cori_login_config['use_gsi'] = True
cori_login_config['path'] = bindir + ':/global/common/cori/das/jupyterhub/:/usr/common/usg/bin:/usr/bin:/bin'
